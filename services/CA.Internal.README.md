# ==> CREATE INTERNAL CA SELF-SIGNED CERTIFICATE <==
...
5. Cat Server certificate and CA cerficate to fullchain.server
   `cat server.crt intermediate.crt ca.crt > fullchain.server.crt`
...
5. Cat Client certificate and CA cerficate to fullchain.client
   `cat server.crt intermediate.crt ca.crt > fullchain.client.crt`
